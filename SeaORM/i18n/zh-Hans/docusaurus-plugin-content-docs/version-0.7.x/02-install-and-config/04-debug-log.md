...
你需要设置[`tracing-subscriber`](https://crates.io/crates/tracing-subscriber)来捕获和查看调试日志。参见下面的代码片段，以及一个完整的示例[这里](https://github.com/SeaQL/sea-orm/blob/master/examples/actix_example/src/main.rs)。
