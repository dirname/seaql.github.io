...
| Rust 类型 | 数据库类型 <br/> ([`ColumnType`](https://docs.rs/sea-orm/0.8/sea_orm/entity/enum.ColumnType.html)) |
| --------- | ------------- |
| `String` | 字符串 |
| `String` | 文本 |
| `i8` | 小整数 |
...
对于 Rust 非基本数据类型的映射。你可以在 [`entity/prelude.rs`](https://github.com/SeaQL/sea-orm/blob/master/src/entity/prelude.rs) 中查看所有重导出的类型。
