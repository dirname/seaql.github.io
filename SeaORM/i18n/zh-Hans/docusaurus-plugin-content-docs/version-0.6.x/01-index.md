...
6. 关系
   ...
   6.4 [连锁关系](07-relation/04-chained-relations.md)

   6.5 [自引用](07-relation/05-self-referencing.md)

   6.6 [面包房模式](07-relation/06-bakery-schema.md)

7. 编写测试

   7.1 [稳健且正确](08-write-test/01-testing.md)
...
8. 高级查询
   ...
   8.4 [自定义联接](09-advanced-query/04-custom-joins.md)
...
9. 内部设计
   ...
   9.1 [特质与类型](10-internal-design/01-trait-and-type.md)
