...
2. 安装与配置
    ...
    2.1 [选择数据库和异步运行时](02-install-and-config/01-database-and-async-runtime.md)
...
5. 基本 CRUD
    ...
    5.1 [基本模式](05-basic-crud/01-basic-schema.md)

    5.2 [SELECT: 查找、过滤、排序、分页](05-basic-crud/02-select.md)

    5.3 [INSERT: 模型和 ActiveModel，批量插入](05-basic-crud/03-insert.md)

    5.4 [UPDATE: 查找和保存，批量更新](05-basic-crud/04-update.md)

    5.5 [SAVE: 插入或更新](05-basic-crud/05-save.md)

    5.6 [DELETE: 删除一个和批量删除](05-basic-crud/06-delete.md)

    5.7 [JSON](05-basic-crud/07-json.md)

    5.8 [原始 SQL 查询](05-basic-crud/08-raw-sql.md)
...
6. 关系
    ...
    6.7 [数据加载器](06-relation/07-data-loader.md)

    6.8 [烘焙店模式](06-relation/08-bakery-schema.md)

7. 编写测试

    7.1 [稳健与正确](07-write-test/01-testing.md)
...
8. 高级查询
    ...
    8.1 [自定义 SELECT](08-advanced-query/01-custom-select.md)
    ...
    8.7 [流式](08-advanced-query/07-streaming.md)
...
10. 海图学
    ...
    10.1 [🧭 海图学介绍](10-seaography/01-seaography-intro.md)

    10.2 [入门指南](10-seaography/02-getting-started.md)

    10.3 [展望未来](10-seaography/03-looking-forward.md)

11. 内部设计

    11.1 [特性与类型](11-internal-design/01-trait-and-type.md)

    11.2 [派生宏](11-internal-design/02-derive-macro.md)

    11.3 [与 Diesel 的比较](11-internal-design/03-diesel.md)

    11.4 [架构](11-internal-design/04-architecture.md)

12. 接下来是什么

    12.1 [接下来是什么](12-whats-next/01-whats-next.md)