...
5. 基本的 CRUD
    ...
    5.3 [INSERT: 模型与 ActiveModel，批量插入](05-basic-crud/03-insert.md)

    5.4 [UPDATE: 查找与保存，批量更新](05-basic-crud/04-update.md)

    5.5 [SAVE: 插入或更新](05-basic-crud/05-save.md)

    5.6 [DELETE: 删除单个与批量删除](05-basic-crud/06-delete.md)
...
6. 关联关系
    ...
    6.4 [链式关联](06-relation/04-chained-relations.md)

    6.5 [自引用](06-relation/05-self-referencing.md)

    6.6 [自定义关联条件](06-relation/06-custom-join-condition.md)

    6.7 [数据加载器](06-relation/07-data-loader.md)

    6.8 [烘焙模式](06-relation/08-bakery-schema.md)

7. 编写测试

    7.1 [稳健且正确](07-write-test/01-testing.md)
