...
`Related` 特性表示我们在实体关系图中绘制的箭头（1-1、1-N、M-N）。一个 [`Linked`](https://docs.rs/sea-orm/*/sea_orm/entity/trait.Linked.html) 是由一系列关系组成的链，当遇到以下情况时非常有用：
...
或者，`RelationDef` 可以即时定义，下面的代码等同于上面的示例：
