...
5. 基本的 CRUD
    ...
    5.3 [INSERT: 模型 & ActiveModel，批量插入](05-basic-crud/03-insert.md)

    5.4 [UPDATE: 查找 & 保存，批量更新](05-basic-crud/04-update.md)

    5.5 [SAVE: 插入或更新](05-basic-crud/05-save.md)

    5.6 [DELETE: 删除单个 & 批量删除](05-basic-crud/06-delete.md)
...
6. 关系
    ...
    6.6 [自定义联接条件](06-relation/06-custom-join-condition.md)

    6.7 [数据加载器](06-relation/07-data-loader.md)

    6.8 [面包店模式](06-relation/08-bakery-schema.md)
...
8. 高级查询
    ...
    8.4 [自定义联接](08-advanced-query/04-custom-joins.md)
...
11. 内部设计
    ...
    11.1 [特质和类型](11-internal-design/01-trait-and-type.md)
...
12. 下一步计划
    ...
    12.1 [下一步计划](12-whats-next/01-whats-next.md)