...
文件后端只是对 tokio / async-std 的异步文件 I/O 的一个薄抽象层。没有涉及网络协议，所以在吞吐量方面尽可能地原始。

查看 [完整示例](https://github.com/SeaQL/sea-streamer/blob/main/sea-streamer-file/tests/producer.rs)。
